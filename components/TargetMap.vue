...
onMounted(async () => {
  ...
  navigator.geolocation.watchPosition(watchPosition, (e: any) => {
    emitsTargetMap("setSnackbar", true, 2000, "warning", e);
    return;
  });
});
...
const watchPosition = (position: any) => {
  ...
  const icons = [
    {
      url: "/images/treasure1.png",
      scaledSize: new google.maps.Size(30, 30),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(0, 0),
    },
    {
      url: "/images/treasure2.png",
      scaledSize: new google.maps.Size(30, 30),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(0, 0),
    },
    {
      url: "/images/treasure3.png",
      scaledSize: new google.maps.Size(30, 30),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(0, 0),
    },
    {
      url: "/images/treasure4.png",
      scaledSize: new google.maps.Size(30, 30),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(0, 0),
    },
    {
      url: "/images/treasure5.png",
      scaledSize: new google.maps.Size(30, 30),
      origin: new google.maps.Point(0, 0),
      anchor: new google.maps.Point(0, 0),
    },
  ...
  propsTargetMap.venue.targets.forEach((target: any, i: number) => {
